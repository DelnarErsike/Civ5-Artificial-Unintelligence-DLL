...
#define UNIQUE_GP_ADMIRAL		128
	...
	int GetPlotDanger(CvPlot& Plot, const CvUnit* pUnit, const CvUnit* pAttackTargetUnit = NULL, const int iAirAction = AIR_ACTION_ATTACK, int iAfterNIntercepts = 0) const;
