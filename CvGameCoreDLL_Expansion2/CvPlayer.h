...
public:
	...
	bool canConstruct(BuildingTypes eBuilding, bool bContinue = false, bool bTestVisible = false, bool bIgnoreCost = false, CvString* toolTipSink = NULL, bool bIgnoreResource = false, int* piWithinEras = NULL) const;
#else
